...
class ModelBase():
    ...
    def set_parameters(self):
        ...
        z_0 = df.Constant(0.0)             # immobile ions (X)
        # z_0 will be calculated later
        z = [z_Na, z_K, z_Cl, z_0]

        # volume fractions
        alpha_i = df.Constant(0.4)
        alpha_e = df.Constant(0.2)
        ...
        # membrane parameters
        gamma_m = df.Constant(8.0e6)       # area to volume ratio [1/m]
    ...
    def set_initial_conditions(self, options: dict = None):
        ...
        # ion concentrations
        self.Na_i_init = in_options['Na_i']    # ICS sodium [mol/m^3]
        self.K_i_init = in_options['K_i']      # ICS potassium [mol/m^3]
        self.Cl_i_init = in_options['Cl_i']    # ICS chloride [mol/m^3]

        self.Na_e_init = in_options['Na_e']    # ECS sodium [mol/m^3]
        self.K_e_init = in_options['K_e']      # ECS potassium [mol/m^3]
        self.Cl_e_init = in_options['Cl_e']    # ECS chloride [mol/m^3]
        ...
        self.inits_PDE = df.Constant((self.Na_i_init,
                                      self.Na_e_init,
                                      self.K_i_init,
                                      self.K_e_init,
                                      self.Cl_i_init,
